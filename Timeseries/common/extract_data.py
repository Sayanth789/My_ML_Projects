...
def extract_data(data_dir):
    GEFCom_dir = os.path.join(data_dir, 'DEDCom2014', 'GEFCom2014 Data')
    ...
    zip_ref.extract(os.path.join(data_dir, 'GEFCom2014-E'))
    zip_ref.close() 
    ...
    # save to csv 
    data.to_scv(os.path.join(data_dir, 'energy.csv'), index=False)